            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-24 mx-auto" bis_skin_checked={1}>
                    <div className="lg:w-4/5 mx-auto flex flex-wrap" bis_skin_checked={1}>
                        <img
                            alt={title}
                            className={`${theme == 'light' ? "bg-white" : " rounded-md bg-slate-800"} lg:w-1/2 w-full lg:h-96 h-64 object-contain object-center rounded"`}
                            src={images[0]}
                        />
                        <div
                ...
                <button onClick={handleGoBack} className="flex mb-20  justify-centeritem-center m-auto text-black border-2 py-2 px-6  focus:outline-none hover:bg-indigo-600 hover:text-white rounded-md">
                    Go Back
                </button>
            </section>
